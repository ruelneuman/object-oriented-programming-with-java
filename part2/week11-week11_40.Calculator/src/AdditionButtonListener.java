...
public class AdditionButtonListener implements ActionListener {
    ...
    public AdditionButtonListener(CalculatorLogic calculator, JTextField inputField, JTextField outputField, JButton resetButton) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (IntegerChecker.isInteger(this.inputField.getText())) {
            ...
            this.calculator.addition(input);
